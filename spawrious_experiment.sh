...
# python -m domainbed.scripts.loop_arch_resnet --dataset_group A --algorithm ERM --architecture resnet18 --da_bool False
# python -m domainbed.scripts.loop_arch_resnet --dataset_group A --algorithm ERM --architecture resnet18 --da_bool True --da_strategy random_shuffle-CutMix
# python -m domainbed.scripts.loop_arch_resnet --dataset_group A --algorithm ERM --architecture resnet18 --da_bool True --da_strategy LISA-Mixup
# python -m domainbed.scripts.loop_arch_resnet --dataset_group A --algorithm ERM --architecture resnet18 --da_bool True --da_strategy LISA-CutMix
# python -m domainbed.scripts.loop_arch_resnet --dataset_group A --algorithm ERM --architecture resnet18 --da_bool True --da_strategy random_shuffle-Mixup

# # Group B, ERM algorithm
# python -m domainbed.scripts.loop_arch_resnet --dataset_group B --algorithm ERM --architecture resnet18 --da_bool False
# python -m domainbed.scripts.loop_arch_resnet --dataset_group B --algorithm ERM --architecture resnet18 --da_bool True --da_strategy random_shuffle-Mixup
# python -m domainbed.scripts.loop_arch_resnet --dataset_group B --algorithm ERM --architecture resnet18 --da_bool True --da_strategy random_shuffle-CutMix
# python -m domainbed.scripts.loop_arch_resnet --dataset_group B --algorithm ERM --architecture resnet18 --da_bool True --da_strategy LISA-Mixup
# python -m domainbed.scripts.loop_arch_resnet --dataset_group B --algorithm ERM --architecture resnet18 --da_bool True --da_strategy LISA-CutMix

# # Group C, ERM algorithm
# python -m domainbed.scripts.loop_arch_resnet --dataset_group C --algorithm ERM --architecture resnet18 --da_bool False
# python -m domainbed.scripts.loop_arch_resnet --dataset_group C --algorithm ERM --architecture resnet18 --da_bool True --da_strategy random_shuffle-Mixup
# python -m domainbed.scripts.loop_arch_resnet --dataset_group C --algorithm ERM --architecture resnet18 --da_bool True --da_strategy random_shuffle-CutMix
# python -m domainbed.scripts.loop_arch_resnet --dataset_group C --algorithm ERM --architecture resnet18 --da_bool True --da_strategy LISA-Mixup
# python -m domainbed.scripts.loop_arch_resnet --dataset_group C --algorithm ERM --architecture resnet18 --da_bool True --da_strategy LISA-CutMix

# # Group A, GroupDRO algorithm
# python -m domainbed.scripts.loop_arch_resnet --dataset_group A --algorithm GroupDRO --architecture resnet18 --da_bool False

# # Group B, GroupDRO algorithm
# python -m domainbed.scripts.loop_arch_resnet --dataset_group B --algorithm GroupDRO --architecture resnet18 --da_bool False

# # Group C, GroupDRO algorithm 
# python -m domainbed.scripts.loop_arch_resnet --dataset_group C --algorithm GroupDRO --architecture resnet18 --da_bool False

# # Group A, MMD-AE algorithm
# python -m domainbed.scripts.loop_arch_resnet --dataset_group A --algorithm MMD-AE --architecture resnet18 --da_bool False

# # Group B, MMD-AE algorithm
# python -m domainbed.scripts.loop_arch_resnet --dataset_group B --algorithm MMD-AE --architecture resnet18 --da_bool False

# # Group C, MMD-AE algorithm
# python -m domainbed.scripts.loop_arch_resnet --dataset_group C --algorithm MMD-AE --architecture resnet18 --da_bool False
